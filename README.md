...
* `Filtering_Stage1.ipynb`: Obtain the descriptives of a compound library and filter out poor candidates.
* `Implicit_Solvent.ipynb`: Perform first-principles electronic structure calculations by quantum chemistry simulations.
